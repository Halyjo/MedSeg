"""
Implementation of UNet, VNet for 2d images and a modified version of VNet for 2d images allowing for
input of more than one image to provide context (2.5d).
Source: https://github.com/jonnedtc/U-Net-PyTorch/blob/master/networks.py
"""
